...
describe('renderColumn', () => {
	describe('container', () => {
		it('returns an HTMLElement', () => {
			const el = renderColumn('inbox', 'Inbox', CARDS, BOARD);
	...
	describe('header', () => {
		...
		it('title element shows the label not the name', () => {
			const el = renderColumn('inbox', 'INBOX DISPLAY', CARDS, BOARD);
